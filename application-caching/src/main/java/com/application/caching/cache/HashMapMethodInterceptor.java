 ...
 * @date 04-July-2015
 */
public class HashMapMethodInterceptor extends AbstractMethodCacheInterceptor implements InitializingBean {

  /** The logger. */

  private static final Logger logger = LoggerFactory.getLogger(HashMapMethodInterceptor.class);
  /** The cache. */
